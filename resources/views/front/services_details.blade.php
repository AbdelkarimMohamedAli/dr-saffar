     ...
     <div class="page-banner-area"<?php if(Cookie::get('locale') == 'ar'){ ?> direction:rtl;<?php } ?>>
            <div class="container">
                <div class="page-banner-content" data-speed="0.06" data-revert="true">
                    <h2 data-aos="fade-right" data-aos-delay="30" data-aos-duration="300"><?php   if(Cookie::get('locale') == 'en'){?> Our-Services  <?php }else{ ?> خداماتنا  <?php } ?></h2>

                    <ul data-aos="fade-right" data-aos-delay="70" data-aos-duration="700">
                        
                        <li><?php   if(Cookie::get('locale') == 'en'){?> Our-Services  <?php }else{ ?> خداماتنا  <?php } ?></li>
                    </ul>
                </div>
                    ...
                    <div class="col-lg-8 col-md-12">
                        <div class="blog-details-desc">
                            <div class="article-content">
                                ...
                                <h3><?php   if(Cookie::get('locale') == 'en'){?> {{ $service->services_title_en }}  <?php }else{ ?> {{ $service->services_title }} <?php } ?></h3>
                                
                                
                                <p style="text-align:justify;"><?php   if(Cookie::get('locale') == 'en'){?> {{ $service->services_desc_en }}  <?php }else{ ?> {{ $service->services_desc }} <?php } ?></p>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <aside class="widget-area">
                            ...
                            <div class="widget widget_medip_posts_thumb">
                                <h3 class="widget-title"><?php   if(Cookie::get('locale') == 'en'){?> Our-Services  <?php }else{ ?> خداماتنا  <?php } ?></h3>
                                ...
                                <?php  foreach($services as $service){ ?> 
                                    <article class="item">
                                        ...
                                        <div class="info">
                                            <h4><a href="{{ route('services_details.show', ['id' => $service->id]) }}"><?php   if(Cookie::get('locale') == 'en'){?> {{ $service->services_title_en }}  <?php }else{ ?> {{ $service->services_title }} <?php } ?></a></h4>
                                        </div>
                                    </article>
                                <?php } ?>
