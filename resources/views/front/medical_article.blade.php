...
">
 ...
 <!-- Start Page Banner Area -->
     <div class="page-banner-area"<?php if(Cookie::get('locale') == 'ar'){ ?> direction:rtl;<?php } ?>>
            <div class="container">
                <div class="page-banner-content" data-speed="0.06" data-revert="true">
                    <h2 data-aos="fade-right" data-aos-delay="30" data-aos-duration="300"><?php   if(Cookie::get('locale') == 'en'){?> Latest-News  <?php }else{ ?>  اخر الأخبار  <?php } ?></h2>

                    <ul data-aos="fade-right" data-aos-delay="70" data-aos-duration="700">
                       
                        <li><?php   if(Cookie::get('locale') == 'en'){?> Latest-News  <?php }else{ ?>  اخر الأخبار  <?php } ?></li>
                    </ul>
                </div>
        ...
        <div class="blog-details-area ptb-100"<?php if(Cookie::get('locale') == 'ar'){ ?> direction:rtl;<?php } ?>>
            <div class="container">
                <div class="row justify-content-center">
                            ...
                            <div class="article-content">
                                ...
                                <ul class="entry-meta">
                                    <li>
                                        ...
                                        <a href="#"><?php   if(Cookie::get('locale') == 'en'){?> {{ $setting[0]['title_en'] }}  <?php }else{ ?> {{ $setting[0]['title'] }} <?php } ?></a>
                                    </li>
                                ...
                                <h3><?php   if(Cookie::get('locale') == 'en'){?> {{ $blog->blog_title_en }}  <?php }else{ ?> {{ $blog->blog_title }} <?php } ?></h3>

                                <p style="text-align:justify;"><?php   if(Cookie::get('locale') == 'en'){?> {{ $blog->blog_desc_en }}  <?php }else{ ?> {{ $blog->blog_desc }} <?php } ?></p>
                            ...
                            <div class="widget widget_medip_posts_thumb">
                                ...
                                <?php  foreach($blogs as $blog){ ?> 
                                    <article class="item">
                                        ...
                                        <div class="info">
                                            <h4><a href="{{ route('medical_news.show', ['id' => $blog->id]) }}"><?php   if(Cookie::get('locale') == 'en'){?> {{ $blog->blog_title_en }}  <?php }else{ ?> {{ $blog->blog_title }} <?php } ?></a></h4>
                                            <span><a href="{{ route('medical_news.show', ['id' => $blog->id]) }}"><?php   if(Cookie::get('locale') == 'en'){?> {{ $setting[0]['title_en'] }}  <?php }else{ ?> {{ $setting[0]['title'] }} <?php } ?></a></span>
                                        </div>
                                    </article>
                                <?php } ?>
