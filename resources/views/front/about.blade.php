...
">
    ...
    <div class="doctors-details-area pt-100 pb-100" <?php if(Cookie::get('locale') == 'ar'){ ?> direction:rtl;<?php } ?>>
            <div class="container">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="doctors-details-desc">
                            <div class="doctors-details-content">
                                <h3> @if(Cookie::get('locale') == 'en') <?php if(!empty($doctor_section)){ ?> {{ $doctor_section[0]['dr_name_en'] }} <?php } ?> @else {{ $doctor_section[0]['dr_name'] }} @endif </h3>
                                <span>@if(Cookie::get('locale') == 'en') <?php if(!empty($doctor_section)){ ?> {{ $doctor_section[0]['dr_medical_title_en'] }} <?php } ?> @else {{ $doctor_section[0]['dr_medical_title'] }} @endif</span>
                                ...
                                <div class="doc-basic-info">
                                    ...
                                    <div class="basic-info-item">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-12">
                                                <p style="text-align:justify">@if(Cookie::get('locale') == 'en') <?php if(!empty($doctor_section)){ ?> {{ $doctor_section[0]['Qualification_en'] }} <?php } ?> @else {{ $doctor_section[0]['Qualification'] }} @endif</p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="dentist-details-overview-content">
                    ...
                    <div class="overview-text">
                        <p>
                        @if(Cookie::get('locale') == 'en')<?php if(!empty($doctor_section)){ ?> {{ $doctor_section[0]['section_desc_en'] }}<?php } ?> @else {{ $doctor_section[0]['section_desc'] }} @endif                   
                    </p>
                    </div>
                </div>
            </div>
